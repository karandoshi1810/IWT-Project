                ...
                <ul class="list">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                         ...
                         <ul class="ml-menu">
                            <li>
                                <a href="IoTDustbin.html">Tracking</a>          
    ...
    <section class="content">
          <div class="card">
            <div class="container">
              ...
              <!--<input type="text" name="IDno" style="border:2px solid black; text-align: center; position: relative; left: 400px;"
              <label style="position: relative;left:380px;">Dustbin ID:</label>
              -->
