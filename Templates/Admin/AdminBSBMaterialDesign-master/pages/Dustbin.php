...
<?php
     ...
     if(isset($_POST['received_dustbin']))
    {
        ...
        We are sorry for the inconvinency. We have received your complain and we will make our best and swift efforts to empty and clean the dustbin in your area.
                                ...
                                <table class="table table-bordered table-striped table-hover dashboard-task-infos dataTable js-basic-example">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "select * from complain where problem='Dustbin'";
                                            ...
                                            while ($row=mysqli_fetch_array($result)) {
                                                ...
                                                echo "<td>".'<input type="submit" name="received_dustbin" value="RECEIVED" class="btn bg-blue waves-effect waves-light">'."</td>";
                                                echo "<td>".'<input type="submit" name="resolved_dustbin" value="RESOLVED" class="btn bg-cyan waves-effect waves-light">'."</td>";
                                                echo "</tr>";
                                                echo "</form>";
                                            }
                                        ?>
