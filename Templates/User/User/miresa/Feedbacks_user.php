...
<meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <div class="container">
          ...
          <h style="font-size: 20px; color: black"><b> Please enter the following details.</b> </h>
           <br> <br>
            <form  action="Feedbacks_form.php" onsubmit="return formValidation();" method="POST">
                 
                <label for="email" style="color: black"><b>Enter Unique ID:</b></label>
                <input type="text" style="margin-left: 150px margin-bottom: 50px" id="uniqueid" placeholder="Enter Unique ID" name="uniqueid" required><span id="uid"></span><br>

                <label for="address" style="color: black"> <b>Address:</b></label>
                <input  style="margin-left: 150px margin-bottom: 50px" type="text" placeholder="Enter Address" name="address" required><br>
                 <label for="email" style="color: black"><b>Type your Feedback here:</b></label>
                <input  style="margin-left: 1px;margin-bottom: 50px" type="text" placeholder="Enter Feedback" name="typefeedback" required><br>
                <label for="email" style="color: black"><b>Email ID:</b></label>
                <input  style="margin-left: 1px;margin-bottom: 50px" type="text" placeholder="Enter Email" id="email" name="email" required><span id="em"></span><br><br>
               <center><h style="color: black"><b>Click the submit button to submit your query</b> </h></center>
                 <input type="submit"  class="block" name="generate" value="Submit">
            </form>
                <br><br><br>
        </div>
        </div>
